...
```{r}
corr_data <- bind_cols(data[,2:8],data[,12:16],data[,21],data[,35:40])
...
```{r}
numerical_data <- bind_cols(data[,2:8],data[,12:16],data[,21:24],data[,35:40])
```
